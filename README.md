...
- La carpeta también traía 3 videos reales de proceso. Se usó uno (recortado a los momentos clave: medir/mezclar y envasar, ~50s, comprimido de 39MB a ~2MB con `ffmpeg`) en la sección "Hecho a mano" (`CraftProcess.jsx`), como video click-to-play (no autoplay, no bloquea la carga). Se omitió deliberadamente el fragmento inicial que menciona el nombre de una fragancia de otra marca, para no hacer un señalamiento directo a un competidor en una web comercial permanente.
